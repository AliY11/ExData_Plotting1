...
plot(household_power_consumption1$DateTime1,household_power_consumption1$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power(kilowatts)")
...
plot(household_power_consumption1$DateTime1, household_power_consumption1$Voltage, type = "l", xlab = "Datetime", ylab = "Voltage")


plot(household_power_consumption1$DateTime1, household_power_consumption1$Global_reactive_power,type = "l",  xlab = "Datetime", ylab = "Global_reactive_power")
